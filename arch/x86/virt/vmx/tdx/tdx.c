...
int tdx_module_shutdown(void)
{
	...
	/*
	 * Set tdx_module_status to TDX_MODULE_ERROR to prevent future
	 * initialization attempts (via tdx_enable()) in case a TDX module
	 * update fails after module shutdown.
	 *
